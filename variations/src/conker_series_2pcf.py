...
class ConKerBox:
    ...
    def __init__(self, data_file: str, rand_file: str, cfg_file: bool,
                 ...
                 data_file2=None, rand_file2=None, zrange=None):
        ...
        with fits.open('./data/'+self.rand_file) as f:
            ...
            if zrange is not None:
                ...
                hdu = fits.BinTableHDU(data=rand_full1[mask_rand_full1])
                rand_full1 = hdu.data
                rand_cols1 = hdu.columns
            ...
            for s_idx in range(len(self.desired_s_bin_centers)):
                ...
                if self.rand_save:
                    ...
                    if use_moments:
                        ...
                        if use_oqe:
                            # if using oqe weights the randoms look like this...
                            # Start file timer
                            file_start_time_W = time.perf_counter()
                            ...
                            # otherwise if using fkp weights the grids look like this...
                            # Start file timer
                            file_start_time_W = time.perf_counter()
