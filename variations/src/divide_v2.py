...
class DivideScheme:
    ...
    def __init__(self, rand_file: str, cfg_file: str, verbose: bool, rand_file2=None):
        ...
        self.fileString = u.getFileString(rand_file, rand_file2)
        # if rand_file2 == None:
        #     self.fileString = rand_file.split('.fits')[0]
        # else:
        #     self.fileString = rand_file.split('.fits')[0].split('.')[0] +\
        ...
        if rand_file2 == None:
            ...
            for colname in rand_cols.names:
                hdu.data[colname][nrows1:] = rand2[colname]
            self.rand = hdu.data
...
def DivideCatalog(rand_file: str, cfg_file: str, save_plan: bool,
    ...
    divp.partitionCatalog(save_plan=save_plan,
                          ...
                          save_plot=save_plot, theta_user = theta_user)
    return           
